    ...
    var mdater = {
      ...
      getDateStr: function(y, m, d) {
        ...
        if (nextMonthStartWeek !== 0) {
          len = endDay + 7 - nextMonthStartWeek + week;
          for (var i = 1; i <= 7 - nextMonthStartWeek; i++) {
            dayStr += '<li class="nextdate" data-day="' + i + '">' + i + '</li>';
          }
        }
        len === 35 ? $('.md_body').height('268px') : $('.md_body').height('300px')
        return dayStr;
      },
      //保存上一次选择的数据
      ...
      saveValueToInput: function() {
        ...
        $('.daytag').text(dateValue + '日').data('day', dateValue);
        $('#date').text(_this.value.year + '-' + monthValue + '-' + dateValue);
      },
        	...
        	<div class="md_panel">
        		<div class="md_head">
        			<div class="md_selectarea">
        				...
        				<a class="md_headtext yeartag" href="javascript:void(0);">年</a>
        				<a class="md_headtext monthtag" href="javascript:void(0);">月</a>
        				<a class="md_headtext daytag" href="javascript:void(0);">日</a>
